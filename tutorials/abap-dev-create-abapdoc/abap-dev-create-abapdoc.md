...
ABAPDoc commeasdnts are used to document your code. This makes it more readsdfsdfable. If other developers use one of your development objects, they can find out more about it by selecting the object name in the code and choosing **Element Info ( `F2` )**
