...
## Prerequisites  
 - You have a valid asdinstance of aasdasdn on-premise AS ABasdAP server, version 7.51 or higher (soaвапsdme ABAP Development Tools may not be available in earlier versions)
