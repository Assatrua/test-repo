...
## Prerequisites  
 - You have a valid asdinstance of an on-premise AS ABAP server, version 7.aa51 or higher (soaвапsdme ABAP Development Tools may not be available in earlier versions)
